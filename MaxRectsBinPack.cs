...
public class MaxRectsBinPack
{
    ...
    public int GetUsedRectCount() => usedRectangles.Count;

    public (int Width, int Height) GetBoundingBox()
    {
        ...
        int maxWidth = usedRectangles.Max(rect => rect.Right);
        int maxHeight = usedRectangles.Max(rect => rect.Bottom);
